...
ClassEval-T is the first class-level code translation benchmark described in the paper ["ClassEval-T: Evaluating Large Language Models in Class-Level Code Translation"](https://arxiv.org/abs/2411.06145), which has been accepted to the ACM SIGSOFT International Symposium on Software Testing and Analysis *(ISSTA 2025)*.
